    ...
    <div className="absolute  inset-0 z-20 grid place-items-center h-full w-full">
      ...
      <div className="content-wrapper w-full relative z-5  h-full grid place-items-center">
        <div className="content-wrapper text-center ">
          ...
          <p className="text-lg secondary-text text-white md:text-xl mt-4 max-w-sm md:max-w-lg mx-auto">
          ...
          <Book className="bg-[#FFCB05] hero-book-button gap-1 mt-6 shadow-md shadow-yellow-500 rounded-sm text-black py-3 px-6 w-[max-content] mx-auto" />
